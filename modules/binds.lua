...
local timer         = "kitty -o font_size=7 -e ~/.cargo/bin/timr-tui -m pomodoro --sound ~/.config/hypr/assets/pomodoro-done.wav"
...
hl.bind(CSH .. " + D", function() -- Quick pin keybind
...
hl.bind(mainMod .. " + M", hl.dsp.exec_cmd("eww active-windows | grep powermenu  && eww close powermenu  || eww open powermenu"))
hl.bind("XF86PowerOff", hl.dsp.exec_cmd("eww active-windows | grep powermenu  && eww close powermenu  || eww open powermenu"))
hl.bind(CSH .. " + E", hl.dsp.exec_cmd(fileManager))
hl.bind(CSH .. " + Z", hl.dsp.exec_cmd("~/.config/hypr/scripts/reload.sh")) -- Reload Script
...
hl.bind(CSH .. " + Q", hl.dsp.exec_cmd("hyprctl clients | grep quake  && hyprctl eval 'hl.dispatch(hl.dsp.workspace.toggle_special(\"quake\"))'  || kitty --title=quake"))
